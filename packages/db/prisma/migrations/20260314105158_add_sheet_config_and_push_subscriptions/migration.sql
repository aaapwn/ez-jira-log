-- AlterTable
ALTER TABLE "user_config" ADD COLUMN     "sheetCheckInRow" INTEGER,
ADD COLUMN     "sheetCheckOutRow" INTEGER,
ADD COLUMN     "sheetName" TEXT,
ADD COLUMN     "sheetSpreadsheetId" TEXT,
ADD COLUMN     "sheetStartColumn" TEXT;
